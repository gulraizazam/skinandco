                ...
                <div class="card card-custom">
                    <div class="card-header py-3">
                        ...
                        <div class="card-toolbar">
                            ...
                            <a href="{{ route('admin.appointmentsmedical.medicals',[$medicalinformation->appointment_id])}}" class="btn btn-sm btn-dark ">
                            ...
                            @if(Gate::allows('appointments_medical_form_manage'))
                                <a href="{{ route('admin.appointmentsmedical.custom_form_feedbacks.export_pdf',request('id')) }}" class="btn btn-sm btn-primary">
