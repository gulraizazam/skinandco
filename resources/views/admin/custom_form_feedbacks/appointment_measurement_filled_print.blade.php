                ...
                <table class="form-data-table">
                    ...
                    @foreach($custom_form->form_fields as $field)
                        ...
                        @elseif($field->field_type ==3)
                            <tr colspan="2">
                                <td>@include("admin.custom_form_feedbacks.preview_fields.single_select_field", ["field_id"=>$field->id, 'title'=>$content["title"],"options"=>$content["options"], "value" => $field->field_value])</td>
                            </tr>
                        @elseif($field->field_type ==4 && is_array($content))
                            <tr colspan="2">
                                <td>@include("admin.custom_form_feedbacks.preview_fields.multi_select_field", ["field_id"=>$field->id, 'title'=>$content["title"],"options"=>$content["options"], "value" => $field->field_value])</td>
                            </tr>
